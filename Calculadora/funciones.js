...
/*
var bRaizCuadrada = document.getElementById('bRaizCuadrada');
bRaizCuadrada.addEventListener('click', function() {raizCuadrada()});

function raizCuadrada() {
    tresultado.value = Math.sqrt(eval(tresultado.value));
}
*/
